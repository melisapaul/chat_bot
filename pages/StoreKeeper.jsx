              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-orange-100">
                    ...
                    selected your store for pickup
                  </p>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Tooltip
                      ...
                      cursor={{ fill: "rgba(153, 27, 27, 0.08)" }}
                    />
                    <Bar
                      dataKey="count"
                      fill="url(#barGradient)"
            ...
            <div className="p-8">
              ...
              <div className="bg-gradient-to-br from-amber-50 to-red-50 rounded-2xl p-6 mb-6 border border-amber-200">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-4xl font-bold bg-gradient-to-r from-red-800 to-amber-600 bg-clip-text text-transparent">
                      {totalOrders}
                    </div>
              ...
              <div className="grid grid-cols-7 gap-3 mt-6">
                {last7DaysData.map((day, index) => (
                  <div
                    key={index}
                    className="bg-white rounded-xl p-4 border-2 border-gray-100 hover:border-amber-300 transition-all hover:shadow-lg"
                  >
              ...
              <div className="mt-6 grid grid-cols-3 gap-4">
                <div className="bg-red-50 rounded-xl p-5 border-2 border-red-200">
                  <div className="text-sm text-red-800 font-bold uppercase tracking-wider mb-2">
                    Peak Day
                  </div>
                ...
                <div className="bg-amber-50 rounded-xl p-5 border-2 border-amber-200">
                  <div className="text-sm text-amber-800 font-bold uppercase tracking-wider mb-2">
                    Avg Daily
                  </div>
                ...
                <div className="bg-orange-50 rounded-xl p-5 border-2 border-orange-200">
                  <div className="text-sm text-orange-800 font-bold uppercase tracking-wider mb-2">
                    Growth
                  </div>
