  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-3 right-3 bg-blue-600 text-white w-10 h-10 rounded-full shadow-2xl flex items-center justify-center text-3xl hover:bg-blue-700 transition-all"
      >
        🤖
      </button>
